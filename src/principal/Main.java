	...
	public static void main(String[] args) {
		...
		try {
			...
			do {
				...
				case 4: 
					...
					case 1:
						...
						if(g.buscar(ciudad)) {
							...
							// Introduce la fecha del viaje que quieres modificar la fecha
							System.out.println("Introduzca la fecha del viaje");
							fecha = sc.nextLine();
							// Te pide una nueva fecha para el viaje que has seleccionado
							System.out.println("Introduzca la nueva fecha del viaje");
							nFecha = sc.nextLine();
							
							// Condicional que ejecuta el metodo modificar fecha y comprueba si se ejecuta correctamente
					...
					case 2:
						...
						if(g.buscar(ciudad)) {
							...
							System.out.println("Introduzca la fecha del viaje");
							fecha = sc.nextLine();
							// Te pide una nuevo precio para el viaje que has seleccionado
							System.out.println("Introduzca el nuevo precio del viaje");
							precio = sc.nextDouble();
							// Condicional que ejecuta el metodo modificarPrecio y comprueba si se ejecuta correctamente
				...
				case 5:
					// Condicional para comprobar si los cambios son guardados correctamente
					if(g.guardarCambios()) {
